...
* probabilty that an element is present at height i is `1/2^i`
...
--> can we initiaize an array with infinite values (e.g. create a ds that can store and retrive all unique integer inputs in O(log(n)) time)
